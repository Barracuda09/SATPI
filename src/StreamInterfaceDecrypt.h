...
*/
#ifndef STREAMINTERFACEDECRYPT_H_INCLUDE
#define STREAMINTERFACEDECRYPT_H_INCLUDE STREAMINTERFACEDECRYPT_H_INCLUDE
...
/// The class @c StreamInterfaceDecrypt is an interface to an @c Stream for decrypting
class StreamInterfaceDecrypt {
	public:
		// =======================================================================
		...
		virtual ~StreamInterfaceDecrypt() {}
...
#endif // STREAMINTERFACEDECRYPT_H_INCLUDE
